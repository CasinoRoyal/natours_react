    ...
    <section className="section-cta">
      <div className="cta">
        <div className="cta__img cta__img--logo">
          <img src={`${process.env.PUBLIC_URL}/img/logo-white.png`} alt="Natours logo" className="" />
        </div>
        <img src={`${process.env.PUBLIC_URL}/img/tours/${images[1]}`} alt="" className="cta__img cta__img--1" />
        <img src={`${process.env.PUBLIC_URL}/img/tours/${images[2]}`} alt="" className="cta__img cta__img--2" />
